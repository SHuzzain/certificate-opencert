...
export const sampleCertificateOfAward: CertificateOfAward = {
  ...
  signature: {
    signature: "data:image/svg+xml;base64,",
    name: "Dr. Jane Smith",
...
export const sampleTestimonial: Testimonial = {
  ...
  testimonial: "Michael has consistently demonstrated exceptional technical skills and leadership abilities throughout his tenure with our organization. His innovative approach to problem-solving and dedication to excellence make him a valuable asset to any team.",
  issuedOn: "2024-01-20"
};